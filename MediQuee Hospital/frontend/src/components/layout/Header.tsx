...
export function Header({ 
  ...
  // Only show top global header on main dashboards. Sub-pages render their own header with back arrow.
  if (!isDashboard) {
    return null;
  }
  ...
  return (
    <header className={cn("bg-surface px-4 z-40 flex flex-col gap-3 shrink-0 relative", role === 'doctor' ? "pt-10 md:pt-4 pb-2 md:pb-3 border-b border-border/40 shadow-xs" : "pt-10 md:pt-4 pb-3 border-b border-border shadow-sm")}>
