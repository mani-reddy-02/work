...
import hospitalProfileRoutes from '../modules/hospital-profile/hospital-profile.routes';
import hospitalRequestsRoutes from '../modules/hospital-requests/hospital-requests.routes';
